...
// 생성 날짜: 2023.07.12 시간 12:46:31 AM KST 
//
...
// 변환 작업에서 참고할 정보를 어노테이션으로 갖고 있다.
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "", propOrder = {
    "sql"
})
@XmlRootElement(name = "sqlmap")
public class Sqlmap { // -> <sqlmap>이 바인딩될 SqlmapType 클래스

    @XmlElement(required = true)
    protected List<SqlType> sql; // -> <sql> 태그의 정보를 담은 Sqltype 객체를 리스트로 갖고 있다.
